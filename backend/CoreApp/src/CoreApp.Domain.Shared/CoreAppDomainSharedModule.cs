...
public class CoreAppDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        CoreAppGlobalFeatureConfigurator.Configure();
        CoreAppModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<CoreAppDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<CoreAppResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/CoreApp");

            options.DefaultResourceType = typeof(CoreAppResource);
        ...
        {
            options.MapCodeNamespace("CoreApp", typeof(CoreAppResource));
        });
    }
}
